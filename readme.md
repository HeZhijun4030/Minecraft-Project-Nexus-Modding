...
**装个b别太当真**
-
**我们已经决定将Minecraft-Nexus闭源处理，我知道这可能是一个不正确的抉择，但是我依旧如此，原因大概归结于我的代码规范可能并不好，并且我不想收到神人发的Issue等等。并且我们为了维护我们开发的初心，（这个项目Mod禁止被用作商业服的敛财工具），而开源则出现无法预料到的可能，或许当我发现一些商业服肆意使用我们的Mod，而我们却不能以任何有效的方式惩罚他们，并且对他们而言只需要剽窃成果并且美美收费便可以成为一些人所追捧的对象。我认为这并不是Nexus乃至Minecraft整个玩家社区想要看到的**
**我们会在未来的某个时间点将Minecraft-Nexus开源，或者说是半开源（也就是只开源部分代码），但是目前我们不打算这么做了。**
**致不完美的明天**

**Silver Wolf 2026年3月25日于家中所记**
-
